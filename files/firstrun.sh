...
# Set HTTP Proxy URL 
# 169.254.169.254 - querying EC2 metadata service
# 169.254.170.2 - querying ECS agent.
if [ -n $PROXY_URL ]
then
...
# Enable docker host networking mode
...
# AWS Logs configuration during instance creation.
...
# Loop unitl ECS agent has registered to ECS cluster
